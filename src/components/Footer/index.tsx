        ...
        <div className="text-center">
          <div className="flex justify-center my-10">
            <div>
              ...
              <p className="text-base text-body-color dark:text-dark-6 mb-7 text-justify italic font-light">
                El rugby personifica la camaradería, el respeto y la lealtad. Es
                un deporte que fomenta la disciplina, el trabajo en equipo y la
                deportividad. Más allá del campo de juego, el rugby enseña
                valiosas lecciones de vida y celebra la fuerza del espíritu
                humano a través del esfuerzo conjunto y el respeto mutuo.
              </p>
              <div className="flex items-center justify-center mb-6">
                ...
                <a
                  href="https://www.instagram.com/rugbypty/"
                  className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke dark:border-dark-3 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                ...
                <a
                  href="https://wa.me/50761023295?text=Quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20el%20evento%20de%20Rugby%20PTY"
                  className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke dark:border-dark-3 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
